			...
			<div class="col-12 col-lg-9 col-xl-7">
				<div class="card shadow-2-strong card-registration"
					...
					<div class="card-body p-4 p-md-5">
						...
						<form action="joinMember.do" method="get" name="joinfrm">
							<div class="row">
							...
							<div class="row">
								<div class="col-md-9 mb-2">
									<div data-mdb-input-init class="form-outline">
										<input type="text" id="email" name="email" placeholder="qwe123@gmail.com"
											class="form-control form-control-lg" /> <label
							...
							<div class="row">
								<div class="col-md-6 mb-4 pb-2">
									...
									<div data-mdb-input-init class="form-outline">
										<input type="text" id="addr1" name="addr2" placeholder="판교역로 166"
											class="form-control form-control-lg" /> <label
								...
								<div class="col-md-6 mb-4 pb-2">
									...
									<div data-mdb-input-init class="form-outline">
										<input type="text" id="addr2" name="addr2" placeholder="304동 105호"
											class="form-control form-control-lg" /> <label
							...
							<div class="row">
								<div class="col-md-9 mb-2">
									<div data-mdb-input-init class="form-outline">
										<input type="text" id="birth" name="birth" placeholder="20020801"
											class="form-control form-control-lg" /> <label
